...
router.get('/passsrecovery', async (req, res, next)=>{
  try {
    ...
    mailSender(
      ...
      '<h1>Recuperación de contraseña</h1><p>Hemos recibido una solicitud para recuperar las credenciales de tu cuenta de SWOT. Si has enviado esta solicitud, haz clic en el siguiente enlace para restablecer tu contraseña: <a href="http://localhost:3000/recovery"> RESTABLECER CONTRASEÑA</></p>'
    );
  } catch (ex) {
    console.log(ex);
